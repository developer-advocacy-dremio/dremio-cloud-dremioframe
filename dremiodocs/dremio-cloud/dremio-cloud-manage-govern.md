...
## Autonomous Management[​](#autonomous-management "Direct link to Autonomous Management")
...
### Materialize and Query Rewrite[​](#materialize-and-query-rewrite "Direct link to Materialize and Query Rewrite")
...
### Role-Based Access Control Policies[​](#role-based-access-control-policies "Direct link to Role-Based Access Control Policies")
...
* [Autonomous Management](#autonomous-management)
  ...
  + [Materialize and Query Rewrite](#materialize-and-query-rewrite)
...
## Privileges Required for Lineage[​](#privileges-required-for-lineage "Direct link to Privileges Required for Lineage")
...
## Lineage Refresh with Dataset Schema Changes[​](#lineage-refresh-with-dataset-schema-changes "Direct link to Lineage Refresh with Dataset Schema Changes")
...
* [Privileges Required for Lineage](#privileges-required-for-lineage)
* [Lineage Refresh with Dataset Schema Changes](#lineage-refresh-with-dataset-schema-changes)
...
## Data File Compaction[​](#data-file-compaction "Direct link to Data File Compaction")
...
## Manifest File Rewriting[​](#manifest-file-rewriting "Direct link to Manifest File Rewriting")
...
## Position Delete Files[​](#position-delete-files "Direct link to Position Delete Files")
...
* [Manifest File Rewriting](#manifest-file-rewriting)
...
### Manage Wikis[​](#manage-wikis "Direct link to Manage Wikis")
...
## Generate Labels and Wikis Preview[​](#generate-labels-and-wikis-preview "Direct link to generate-labels-and-wikis-preview")
...
#### Generate Labels[​](#generate-labels "Direct link to Generate Labels")
...
#### Generate Wikis[​](#generate-wikis "Direct link to Generate Wikis")
...
* [Generate Labels and Wikis Preview](#generate-labels-and-wikis-preview)
* [Related Topics](#related-topics)
...
## Column-Masking Policies[​](#column-masking-policies "Direct link to Column-Masking Policies")
...
## Row-Access Policies[​](#row-access-policies "Direct link to Row-Access Policies")
...
## User-Defined Functions[​](#user-defined-functions "Direct link to User-Defined Functions")
...
### Query Substitutions[​](#query-substitutions "Direct link to Query Substitutions")
...
2. The engine searches for any security policies set to the associated objects, such as protect\_ssn (see [Examples of UDFs below](#examples-of-udfs)).
...
## List Existing UDFs[​](#list-existing-udfs "Direct link to List Existing UDFs")

To view all existing UDFs created in Dremio, use the [`SHOW FUNCTIONS`](/dremio-cloud/sql/commands/show-functions/) SQL command.

## List Existing Policies[​](#list-existing-policies "Direct link to List Existing Policies")
...
## Set a Policy[​](#set-a-policy "Direct link to Set a Policy")
...
## Drop a Policy[​](#drop-a-policy "Direct link to Drop a Policy")
...
## Examples of UDFs[​](#examples-of-udfs "Direct link to Examples of UDFs")

The following are examples of user-defined functions that you may create with Dremio.

### Column-Masking Policies[​](#column-masking-policies-1 "Direct link to Column-Masking Policies")
...
### Row-Access Policies[​](#row-access-policies-1 "Direct link to Row-Access Policies")
...
### Table-Driven Policy with a Subquery[​](#table-driven-policy-with-a-subquery "Direct link to Table-Driven Policy with a Subquery")
...
## Use Reflections on Datasets with Policies[​](#use-reflections-on-datasets-with-policies "Direct link to Use Reflections on Datasets with Policies")
...
* [Policies with Multiple Arguments](#policies-with-multiple-arguments)
* [Aggregates on Masked Columns](#aggregates-on-masked-columns)
* [SET Operations](#set-operations)
* [NULL Generating JOINs](#null-generating-joins)
* [Trimming Projects](#trimming-projects)

#### Policies with Multiple Arguments[​](#policies-with-multiple-arguments "Direct link to Policies with Multiple Arguments")
...
#### Aggregates on Masked Columns[​](#aggregates-on-masked-columns "Direct link to Aggregates on Masked Columns")
...
#### NULL Generating JOINs[​](#null-generating-joins "Direct link to NULL Generating JOINs")
...
#### SET Operations[​](#set-operations "Direct link to SET Operations")
...
#### Trim Projects[​](#trim-projects "Direct link to Trim Projects")
...
#### Trimming Projects[​](#trimming-projects "Direct link to Trimming Projects")
...
* [User-Defined Functions](#user-defined-functions)
  + [Query Substitutions](#query-substitutions)
* [List Existing UDFs](#list-existing-udfs)
* [List Existing Policies](#list-existing-policies)
* [Set a Policy](#set-a-policy)
* [Drop a Policy](#drop-a-policy)
* [Examples of UDFs](#examples-of-udfs)
  + [Column-Masking Policies](#column-masking-policies-1)
  + [Row-Access Policies](#row-access-policies-1)
  + [Table-Driven Policy with a Subquery](#table-driven-policy-with-a-subquery)
* [Use Reflections on Datasets with Policies](#use-reflections-on-datasets-with-policies)

...
## Step 1: Discover and Explore Your Data[​](#step-1-discover-and-explore-your-data "Direct link to Step 1: Discover and Explore Your Data")
...
## Step 2: Compare User Behavior[​](#step-2-compare-user-behavior "Direct link to Step 2: Compare User Behavior")
...
## Step 3: Analyze Peak Demand Patterns[​](#step-3-analyze-peak-demand-patterns "Direct link to Step 3: Analyze Peak Demand Patterns")
...
## Step 4: Run Comparative Analysis[​](#step-4-run-comparative-analysis "Direct link to Step 4: Run Comparative Analysis")
...
## Step 5: Try Your Own Analysis[​](#step-5-try-your-own-analysis "Direct link to Step 5: Try Your Own Analysis")
...
* [Step 1: Discover and Explore Your Data](#step-1-discover-and-explore-your-data)
* [Step 2: Compare User Behavior](#step-2-compare-user-behavior)
* [Step 3: Analyze Peak Demand Patterns](#step-3-analyze-peak-demand-patterns)
* [Step 4: Run Comparative Analysis](#step-4-run-comparative-analysis)
* [Step 5: Try Your Own Analysis](#step-5-try-your-own-analysis)
* [Summary](#summary)
...
## Step 1: Identify a Business Use Case[​](#step-1-identify-a-business-use-case "Direct link to Step 1: Identify a Business Use Case")
...
## Step 2: Add Your Data[​](#step-2-add-your-data "Direct link to Step 2: Add Your Data")

To implement the data model that answers the business question you identified in the [Identify a Business Use Case](#step-1-identify-a-business-use-case) section, you will first add your data to the project in your Dremio Cloud account.

### How to Do It[​](#how-to-do-it-1 "Direct link to How to Do It")
...
## Step 3: Clean and Transform Data[​](#step-3-clean-and-transform-data "Direct link to Step 3: Clean and Transform Data")
...
### How to Do It[​](#how-to-do-it-2 "Direct link to How to Do It")
...
## Step 4: Build Views for Aggregations and Metrics[​](#step-4-build-views-for-aggregations-and-metrics "Direct link to Step 4: Build Views for Aggregations and Metrics")
...
### How to Do It[​](#how-to-do-it-3 "Direct link to How to Do It")
...
## Step 5: Add Semantics to Views[​](#step-5-add-semantics-to-views "Direct link to Step 5: Add Semantics to Views")
...
### How to Do It[​](#how-to-do-it-4 "Direct link to How to Do It")
...
## Step 6: Deliver Insights[​](#step-6-deliver-insights "Direct link to Step 6: Deliver Insights")
...
### How to Do It[​](#how-to-do-it-5 "Direct link to How to Do It")
...
## Step 7: Operationalize the Use Case[​](#step-7-operationalize-the-use-case "Direct link to Step 7: Operationalize the Use Case")

Each use case is operationalized when it's governed, monitored, and shareable.

### How to Do It[​](#how-to-do-it-6 "Direct link to How to Do It")
...
## Wrap Up and Next Steps[​](#wrap-up-and-next-steps "Direct link to Wrap Up and Next Steps")
...
* [Step 1: Identify a Business Use Case](#step-1-identify-a-business-use-case)
  + [How to Do It](#how-to-do-it)
* [Step 2: Add Your Data](#step-2-add-your-data)
  + [How to Do It](#how-to-do-it-1)
* [Step 3: Clean and Transform Data](#step-3-clean-and-transform-data)
  + [How to Do It](#how-to-do-it-2)
* [Step 4: Build Views for Aggregations and Metrics](#step-4-build-views-for-aggregations-and-metrics)
  + [How to Do It](#how-to-do-it-3)
* [Step 5: Add Semantics to Views](#step-5-add-semantics-to-views)
  + [How to Do It](#how-to-do-it-4)
* [Step 6: Deliver Insights](#step-6-deliver-insights)
  + [How to Do It](#how-to-do-it-5)
* [Step 7: Operationalize the Use Case](#step-7-operationalize-the-use-case)
...
## Console Navigation[​](#console-navigation "Direct link to Console Navigation")

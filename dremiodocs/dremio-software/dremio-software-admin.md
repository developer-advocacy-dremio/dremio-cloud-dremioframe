...
### Monitoring Logs and Usage[​](#monitoring-logs-and-usage "Direct link to Monitoring Logs and Usage")
...
### Changing Your Configuration[​](#changing-your-configuration "Direct link to Changing Your Configuration")
...
### Using Support Keys[​](#using-support-keys "Direct link to Using Support Keys")
...
### Using the Dremio Admin CLI on Kubernetes[​](#using-the-dremio-admin-cli-on-kubernetes "Direct link to Using the Dremio Admin CLI on Kubernetes")
...
* [Monitoring Logs and Usage](#monitoring-logs-and-usage)
* [Managing Workloads](#managing-workloads)
* [Changing Your Configuration](#changing-your-configuration)
* [Using Support Keys](#using-support-keys)
* [Using the Dremio Admin CLI on Kubernetes](#using-the-dremio-admin-cli-on-kubernetes)
...
## License Key Requirement[​](#license-key-requirement "Direct link to License Key Requirement")
...
## Obtain a License Key[​](#obtain-a-license-key "Direct link to Obtain a License Key")
...
## Use Your License Key for Kubernetes Deployment[​](#use-your-license-key-for-kubernetes-deployment "Direct link to Use Your License Key for Kubernetes Deployment")

To ensure your Dremio cluster starts up correctly, follow these steps to apply your license key:

1. Open the license file you have obtained in the support ticket (see the section above on [How to Obtain a License Key](#how-to-obtain-a-license-key)), and copy the license key string.
...
## Verify Your License[​](#verify-your-license "Direct link to Verify Your License")
...
* [License Key Requirement](#license-key-requirement)
* [Obtain a License Key](#obtain-a-license-key)
* [Use Your License Key for Kubernetes Deployment](#use-your-license-key-for-kubernetes-deployment)
...
## View Your Billing[​](#view-your-billing "Direct link to View Your Billing")
...
* [View Your Billing](#view-your-billing)
...
## Telemetry Data Collection[​](#telemetry-data-collection "Direct link to Telemetry Data Collection")
...
## Telemetry Transmission Requirements[​](#telemetry-transmission-requirements "Direct link to Telemetry Transmission Requirements")
...
### Network Requirements for Telemetry Transmission[​](#network-requirements-for-telemetry-transmission "Direct link to Network Requirements for Telemetry Transmission")
...
### Setting Up a Proxy[​](#setting-up-a-proxy "Direct link to Setting Up a Proxy")
...
## Troubleshooting or Support[​](#troubleshooting-or-support "Direct link to Troubleshooting or Support")
...
* [Telemetry Transmission Requirements](#telemetry-transmission-requirements)
  + [Network Requirements for Telemetry Transmission](#network-requirements-for-telemetry-transmission)
  + [Setting Up a Proxy](#setting-up-a-proxy)
* [Troubleshooting or Support](#troubleshooting-or-support)
...
## Automated Backups[​](#automated-backups "Direct link to Automated Backups")
...
### Restore From a Full Backup[​](#restore-from-a-full-backup "Direct link to Restore From a Full Backup")
